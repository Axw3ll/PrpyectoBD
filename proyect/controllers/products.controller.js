      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            quantity = req.body.quantity; //Valida los datos para insertarlos en la bd
          ...
          case 8:
            pool = _context2.sent;
            _context2.next = 11;
            return pool.request().input('name', _database.sql.VarChar, name).input('description', _database.sql.Text, description).input('quantity', _database.sql.Int, quantity).query(_database.querys.createNewProduct);
          case 11:
            res.json({
              name: name,
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            pool = _context3.sent;
            _context3.next = 6;
            return pool.request().input('id', id).query(_database.querys.getProductById);
          case 6:
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            pool = _context4.sent;
            _context4.next = 6;
            return pool.request().input('id', id).query(_database.querys.deleteProductById);
          case 6:
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 6:
            pool = _context6.sent;
            _context6.next = 9;
            return pool.request().input('name', _database.sql.VarChar, name).input('description', _database.sql.Text, description).input('quantity', _database.sql.Int, quantity).input('id', _database.sql.Int, id).query(_database.querys.updateProductsById);
          case 9:
            res.json({
              name: name,
              description: description,
